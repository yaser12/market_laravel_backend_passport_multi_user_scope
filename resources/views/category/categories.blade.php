...
<div id="container" class="container">
    ...
    <select style="float: left" class='search-select' id="son_select" style='width: 200px;' title="Choose Category"
        ...
        @foreach($categories as $category)
            <option data-id="{{$category->id}}"
                    data-category_name_ar="{{$category->category_name_ar.$category->parent}}"
                    data-category_name_en="{{$category->category_name_en.$category->parent}}"
                    ...
                    data-min_price_old_="{{$category->min_price_old}}">{{$category->id.' - '.$category->category_name_en.' - '.$category->parent}}</option>
        @endforeach
    </select>
    ...
    <div id="myModalAdd" class="modal">
        ...
        <div class="modal-content">
            ...
            <input class="form-control" type="text" placeholder="insert a show_pages" name="show_pages">
            <table>
                <tr>
                    <td>
                        img_tabe_site_photo
    ...
    <select style="float: left" id="parent_select" class='search-select' style='width: 200px;' title="Choose Category"
        ...
        @foreach($categories as $category)
            <option data-id="{{$category->id}}">{{$category->id.' - '.$category->id.' - '.$category->category_name_en.$category->parent}}</option>
        @endforeach
    </select>
